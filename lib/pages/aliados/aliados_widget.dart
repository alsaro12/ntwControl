...
import 'aliados_model.dart';
export 'aliados_model.dart';

class AliadosWidget extends StatefulWidget {
  const AliadosWidget({Key? key}) : super(key: key);
...
class _AliadosWidgetState extends State<AliadosWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AliadosModel());
